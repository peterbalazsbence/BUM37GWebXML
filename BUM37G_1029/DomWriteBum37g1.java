...
public class DOMWrite1 {
    ...
    public static void main(String[] args) {
        try {
            File inputFile = new File("orarendBum37g.xml");
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = factory.newDocumentBuilder();
            Document doc = builder.parse(inputFile);
            doc.getDocumentElement().normalize();

            System.out.println("=== Órarend fastruktúrája ===");
            ...
            StreamResult fileResult = new StreamResult(new File("orarend1Bum37g.xml"));
            transformer.transform(source, fileResult);

            System.out.println("\n Sikeres fajl letrehozas: orarend1Bum37g.xml");
